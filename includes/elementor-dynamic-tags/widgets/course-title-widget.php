 ...
 * Course Title Widget
 */
class Course_Title_Widget extends Widget_Base {
    ...
    public function get_keywords(): array {
        return ['course', 'title', 'heading', 'kurs', 'tytuł', 'nagłówek'];
    }
    ...
    protected function register_controls(): void {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .simple-lms-course-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .simple-lms-course-title' => 'color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render(): void {
        ...
        if (!$course_id) {
            if (!empty($settings['fallback_text'])) {
                echo '<div class="simple-lms-course-title">' . esc_html($settings['fallback_text']) . '</div>';
            }
            return;
        }
        ...
        echo '<div class="simple-lms-course-title">';
