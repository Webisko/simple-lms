...
class User_Progress_Dashboard extends \Bricks\Element {
    ...
    public function render() {
        ...
        echo '<div style="padding:20px;background:#fff;border-radius:6px;text-align:center"><div style="font-size:32px;font-weight:700;color:#4CAF50">'.$avg_progress.'%</div><div style="color:#666">Średni postęp</div></div>';
        echo '</div>';
