...
class Lesson_Completion_Button extends \Bricks\Element {
    ...
    public function set_controls() {
        ...
        $this->controls['completedText'] = ['tab'=>'content','label'=>esc_html__('Completed Text','simple-lms'),'type'=>'text','default'=>'Lekcja ukończona'];
        $this->controls['incompleteText'] = ['tab'=>'content','label'=>esc_html__('Incomplete Text','simple-lms'),'type'=>'text','default'=>'Oznacz jako ukończone'];
    }
    ...
    public function render() {
        ...
        $text = $completed ? ($settings['completedText'] ?? 'Lekcja ukończona') : ($settings['incompleteText'] ?? 'Oznacz jako ukończone');
